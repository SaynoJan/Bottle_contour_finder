...
class ObjectContourDetector:
    ...
    VOLUME_STANDARDS = {
        0.33: {
            'min': 180000,  # Минимальное значение из таблицы (181391)
            'max': 280000,  # Максимальное значение из таблицы (276907)
            'avg': 235000,  # Приблизительное среднее
            'values': [254669, 276907, 225615, 258788, 219435, 214870, 229095, 256460, 181391]
        },
        0.5: {
            'min': 275000,  # Минимальное значение из таблицы (275351)
            'max': 363000,  # Максимальное значение из таблицы (362178)
            'avg': 320000,  # Приблизительное среднее
        ...
        1.0: {
            'min': 640000,  # Минимальное значение из таблицы (644879)
            'max': 680000,  # Максимальное значение из таблицы (679867)
            'avg': 660000,  # Приблизительное среднее
